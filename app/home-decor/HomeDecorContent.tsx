...
export default function HomeDecorPage() {
  ...
  const categories = [
    "All",
    ...Array.from(new Set(decorItems.map((item) => item.category))),
  ];
  ...
  return (
    <section className="min-h-screen bg-[#e5d385] py-20 px-6 md:px-16">
      {/* Header */}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto mb-10 gap-6">
        ...
        <div className="relative w-full md:w-1/2">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 border border-gray-200 text-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-[#B98E75]"
          />
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="border border-gray-300 text-gray-600 rounded-full px-4 py-2 focus:ring-2 focus:ring-[#B98E75]"
          >
            {categories.map((cat) => (
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {filteredItems.map((item, index) => (
          ...
          >
            ...
            <div className="p-6">
              <Link
                href={`/home-decor/${item.id}`}
                className="block text-xl font-semibold text-gray-800 mb-2 hover:text-[#B98E75] transition"
              >
                {item.name}
              </Link>
